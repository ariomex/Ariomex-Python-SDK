...
def main():
    ...
    # Create an Ariomex client instance
    ...
    # withdrawalResponse = ariomex.wallet.withdrawCrypto(
    #     "btc", "btc", "1", "address_uuid_here", "optional_memo"
    # )
    ...
    # irtDeposits = ariomex.history.getIrtDeposits(
    #     "1715719124700", "1715719124700", "completed", "1", "50"
    # )
    # # Example usage of the getCryptoDeposits method
    # cryptoDeposits = ariomex.history.getCryptoDeposits(
    #     "btc", "btc", "1715719124700", "1715719124700", "completed", "1", "50"
    # )
    # # Example usage of the getIrtWithdrawals method
    # irtWithdrawals = ariomex.history.getIrtWithdrawals(
    #     "1715719124700", "1715719124700", "completed", "1", "50"
    # )
    # # Example usage of the getCryptoWithdrawals method
    # cryptoWithdrawals = ariomex.history.getCryptoWithdrawals(
    #     "btc", "btc", "1715719124700", "1715719124700", "completed", "1", "50"
    # )
    # # Example usage of the getOrders method
    # orders = ariomex.history.getOrders(
    #     "btcusdt",
    #     "",
    #     "1715719124700",
    #     "1715719124700",
    ...
    # trades = ariomex.history.getTrades(
    #     "btcusdt", "1715719124700", "1715719124700", "buy", "1", "50"
    # )
    # ### Order
    ...
    # stoplimitSellOrder = ariomex.order.setStoplimitSell(
    #     "btcusdt", "0.1", "10500", "10400"
    # )
